		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comrebithrleaveapplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebithrleaveapplication-display": {
								"semanticObject": "comrebithrleaveapplication",
								"action": "display",
								"description": "Leave Application on Jan 13",
								"title": "Leave Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.hr.leaveapplication",
									"url": sap.ui.require.toUrl("com/rebit/hr/leaveapplication")
								}
							}
						}
					}
