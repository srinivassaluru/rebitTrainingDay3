		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comui5srinivastestrouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comui5srinivastestrouting-display": {
								"semanticObject": "comui5srinivastestrouting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ui5.srinivas.testrouting",
									"url": sap.ui.require.toUrl("com/ui5/srinivas/testrouting")
								}
							}
						}
					}
