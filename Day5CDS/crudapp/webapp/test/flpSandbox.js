		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD Service",
									"targetURL": "#comrebitui5crudapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebitui5crudapp-display": {
								"semanticObject": "comrebitui5crudapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.ui5.crudapp",
									"url": sap.ui.require.toUrl("com/rebit/ui5/crudapp")
								}
							}
						}
					}
