		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test App ",
									"targetURL": "#comrebitui5testday5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebitui5testday5-display": {
								"semanticObject": "comrebitui5testday5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.ui5.testday5",
									"url": sap.ui.require.toUrl("com/rebit/ui5/testday5")
								}
							}
						}
					}
