		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comrebitui5leaveapplicationday4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebitui5leaveapplicationday4-display": {
								"semanticObject": "comrebitui5leaveapplicationday4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.ui5.leaveapplicationday4",
									"url": sap.ui.require.toUrl("com/rebit/ui5/leaveapplicationday4")
								}
							}
						}
					}
