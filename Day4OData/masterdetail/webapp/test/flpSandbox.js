		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comrebitui5masterdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebitui5masterdetail-display": {
								"semanticObject": "comrebitui5masterdetail",
								"action": "display",
								"description": "Master Detail with Northwind",
								"title": "Master Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.ui5.masterdetail",
									"url": sap.ui.require.toUrl("com/rebit/ui5/masterdetail")
								}
							}
						}
					}
