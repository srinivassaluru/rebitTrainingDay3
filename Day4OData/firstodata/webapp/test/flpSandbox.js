		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comrebitui5firstodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebitui5firstodata-display": {
								"semanticObject": "comrebitui5firstodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.ui5.firstodata",
									"url": sap.ui.require.toUrl("com/rebit/ui5/firstodata")
								}
							}
						}
					}
