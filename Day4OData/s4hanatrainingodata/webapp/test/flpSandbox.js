		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD Odata",
									"targetURL": "#comrebitui5s4hanatrainingodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comrebitui5s4hanatrainingodata-display": {
								"semanticObject": "comrebitui5s4hanatrainingodata",
								"action": "display",
								"description": "CRUD Odata",
								"title": "CRUD Odata",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.rebit.ui5.s4hanatrainingodata",
									"url": sap.ui.require.toUrl("com/rebit/ui5/s4hanatrainingodata")
								}
							}
						}
					}
